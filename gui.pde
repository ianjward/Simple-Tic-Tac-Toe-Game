...
public void imgButton1_click1(MyImageButton source, GEvent event) { //_CODE_:imgButton1:581601:
  ...
  imgButton1.setImage(new String[] {"o.png","o.png","o.png"});
...
public void createGUI(){
  ...
  imgButton1 = new MyImageButton(this, 40, 24, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton1.addEventHandler(this, "imgButton1_click1");
  
  imgButton2 = new MyImageButton(this, 190, 24, 85, 85, new String[] { "x.png", "x.png", "x.png" } );  
  imgButton2.addEventHandler(this, "imgButton2_click1");
  
  imgButton3 = new MyImageButton(this, 360, 24, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton3.addEventHandler(this, "imgButton3_click1");
  

  
  imgButton4 = new MyImageButton(this, 40, 133, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton4.addEventHandler(this, "imgButton4_click1");
  
  imgButton5 = new MyImageButton(this, 190, 133, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton5.addEventHandler(this, "imgButton5_click1");

  imgButton6 = new MyImageButton(this, 360, 133, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton6.addEventHandler(this, "imgButton6_click1");
  
  
  
  imgButton7 = new MyImageButton(this, 40, 235, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton7.addEventHandler(this, "imgButton7_click1");
  
  imgButton8 = new MyImageButton(this, 190, 235, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
  imgButton8.addEventHandler(this, "imgButton8_click1");
  
  imgButton9 = new MyImageButton(this, 360, 235, 85, 85, new String[] { "x.png", "x.png", "x.png" } );
